...
| DEF-011: CIP Add Cost form silently produced non-capitalizable costs | No `isCapitalizable` input on form; bool defaulted to `false` | [#68](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/68) |
| DEF-012: CipCapitalizations + CipCapitalizationCosts schema drift | Tables were never created by a migration — diverged from model snapshot | [#69](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/69) |
| DEF-013: CipCapitalizationService not atomic | Three separate `SaveChanges` left orphan Assets on partial failure | [#70](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/70) |
| DEF-014: CIP-capitalized assets non-depreciable | Form never asked for `UsefulLifeMonths`; service never created `AssetBookSettings` | [#71](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/71) |
| DEF-015: `/Journals/Index` modal binding mismatch | Form posted `BookId`/`PeriodEnd`, handler bound `GenerateBookId`/`GenerateMonth` | [#72](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/72) |
| DEF-016: duplicate Generate Depreciation surface | Index modal + standalone Generate page → consolidated to standalone | [#73](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/73) |
| DEF-017: monthly Generate didn't refresh per-asset book snapshots | JE wrote aggregate truth; per-asset rows stayed stale | [#74](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/74) |
| DEF-009: leaked markdown debug footers in three page templates | 149 lines of literal text at the bottom of AP/WO/CIP Details pages | [#75](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/75) |
| DEF-010: CIP Add Cost form used free-form Vendor + Invoice text | Schema had `VendorId` + `VendorInvoiceId` FK columns; form bypassed them | [#76](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/76) |
| DEF-008 follow-up: Item edit page Default Location picker | Schema FK shipped in [#64](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/64); operator UI to set it was missing | [#77](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/77) |
| S2-1: legacy `MaintenanceSchedule` tenant-scope leak + deprecation | `GenerateEventsFromSchedulesAsync` fetched cross-tenant; marked `[Obsolete]` | [#78](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/78) |
| S2-2: PM meter-based recurrence projection foundation | New `ProjectMeterCrossingDateAsync` + tests; scheduler wiring follow-up | [#79](https://github.com/CherryStreet2020/CherryEnterpriseAssetManagement/pull/79) |
