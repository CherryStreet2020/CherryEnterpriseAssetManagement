...
namespace Abs.FixedAssets.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // The migration 20260524120000 drops the global UNIQUE and creates the
            // composite via raw SQL with a custom name; this HasIndex mirrors that
            // so the EF model stays consistent.
