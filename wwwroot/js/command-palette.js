(function() {
    ...
    var ROUTES = [
        ...
        { group: 'Finance', label: 'Compliance Reports', path: '/Reports/Compliance', icon: 'fa-shield-alt' },
        { group: 'Finance', label: 'Form 4562 (US)', path: '/Reports/Form4562', icon: 'fa-file-alt' },
        { group: 'Finance', label: 'T2 Schedule 8 (CA)', path: '/Reports/T2Schedule8', icon: 'fa-file-alt' },
        ...
        { group: 'Admin', label: 'Smoke Tests', path: '/Admin/SmokeTests', icon: 'fa-flask' },
        ...
        { group: 'Admin', label: 'Demo Data', path: '/Admin/DemoData', icon: 'fa-database' },
