...
public class CipAutoCostPostingWiringTests
{
    ...
    public async Task Receive_LineWithCipProjectIdOnPoLine_PostsCipCost()
    {
        ...
        var receivingPostingR = new Abs.FixedAssets.Services.Receiving.ReceivingPostingService(db, tenant, glResolverR, outboxR, new PassthroughIdempotencyMediator(), new Abs.FixedAssets.Tests.TestHelpers.NullChainOfCustodyService(), new Abs.FixedAssets.Tests.TestHelpers.NullReceiptToJobService(), NullLogger<Abs.FixedAssets.Services.Receiving.ReceivingPostingService>.Instance);
