...
namespace Abs.FixedAssets.Services
{
    ...
    public class HistoricJournalBookSummary
    {
        ...
        public decimal ComputedScheduleTotal { get; set; }
    ...
    public class HistoricJournalBackfillService
    {
            ...
            bool dryRun)
        {
            ...
            // Reconciliation drift: warn when computed schedule total differs from the
            // stamped settings.AccumulatedDepreciation by more than $1. Drift typically
            // means accumulated values were manually adjusted or generated by older logic.
            ...
            {
                summary.Warning = $"Computed schedule total ${summary.ComputedScheduleTotal:N2} differs from stamped Acc ${summary.SettingsAccumulated:N2} by ${summary.ReconciliationDelta:N2}. Run Depreciation Backfill to re-stamp, or investigate manual adjustments.";
            }
